<?php
	...
	$sql = "SELECT * FROM link where 1=1 ORDER BY `sort` DESC, `id` DESC ";
						...
						<div class="news_table">
							<table width="100%" border="0">
								...
								<tr style='border-bottom:1px solid #f2f2f2'>
									<td><a href="linkedit?type=new&typeid=<?=$type?>"><i class="mdi mdi-plus-box"></i></a>
									<td>新增
									<!-- <td> -->
									<td>
									<td>
								...
								?>
								<tr>
									<td><a href="linkedit?type=edit&id=<?=$data["id"]?>"><i class="mdi mdi-file-document-edit"></i></a>
