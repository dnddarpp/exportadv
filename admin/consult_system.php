...
$urlname1 = $conn->real_escape_string($_POST['urlname1']);
$urlname2 = $conn->real_escape_string($_POST['urlname2']);
$urlname3 = $conn->real_escape_string($_POST['urlname3']);
$urlname4 = $conn->real_escape_string($_POST['urlname4']);
$urlname5 = $conn->real_escape_string($_POST['urlname5']);
