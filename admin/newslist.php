			...
			<div class="side_wrapper">
				...
				<div class="sidebar">
					<div class="right_continer">
						<div class="adsright_title">最新消息-新聞管理</div>
						<form>
						...
						<div class="news_table">
							<table width="100%" border="0">
								<tr>
									...
									<td class="tab_gray" width="5%">類別
									<td class="tab_gray" width="5%">發佈日期
								<tr style='border-bottom:1px solid #f2f2f2'>
									<td><a href=news_more.0><i class="mdi mdi-plus-box"></i></a>
									<td>
									<td>
									<td>新增消息
									<td>
									<td>
								<tr>
									<td><a href="newsedit"><i class="mdi mdi-file-document-edit"></i></a>
